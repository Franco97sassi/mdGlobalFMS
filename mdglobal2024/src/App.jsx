...
<Route path="/cotizar" element={<Cotizacion/>}> </Route>
 <Route path="/aduanas" element={<Aduanas/>}> </Route>
<Route path="/nosotros" element={<Nosotros/>}> </Route>

<Route path="/asesoriaPrim" element={<AsesoriaPrim/>}> </Route>  
<Route path="/asesoriaSeg" element={<AsesoriaSeg/>}> </Route>  
<Route path="/asesoriaTer" element={<AsesoriaTer/>}> </Route>  
<Route path="/asesoriaCuar" element={<AsesoriaCuar/>}> </Route>  
<Route path="/asesoriaQuin" element={<AsesoriaQuin/>}> </Route>  
<Route path="/asesoriaSex" element={<AsesoriaSex/>}> </Route>  
<Route path="/asesoriaSep" element={<AsesoriaSep/>}> </Route>  
